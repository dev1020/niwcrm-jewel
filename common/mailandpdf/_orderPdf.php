...
<div id="wrapper">
    <table id="head-top" style="width:100%;">
        <tr>
            <td style="width:30%;"><img style="width:60mm" src="/images/logo.png" alt="" /></td>
        ...
        <div id="invoice_total">
            ...
            <table>
                <tr>
                    ...
                    <td style="text-align:left; padding-left:10px; text-decora"><?= Yii::$app->formatter->asSpellout($order->total_amount) ?></td>
