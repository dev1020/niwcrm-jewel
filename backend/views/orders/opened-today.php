...
$this->title = 'Today\'s Opened Orders';
...
<div class="orders-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'pjax'=>true,
            'columns' => require(__DIR__.'/_columns-today.php'),
            'toolbar'=> [
                ['content'=>
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Todays\' Orders',
                ...
                'after'=>BulkButtonWidget::widget([
                        ...
                        ]).Html::button('<i class="fa fa-paper-plane"></i>&nbsp; Send Bulk SMS',
                                [
