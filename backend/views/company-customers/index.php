...
/* @var $searchModel backend\models\CompanyCustomersSearch */
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Create new Company Customers','class'=>'btn btn-success']).
            ...
            'panel' => [
                'type' => 'primary', 
                'heading' => '<i class="glyphicon glyphicon-list"></i> Company Customers listing',
