    ...
    <div class="row">
		<div class="col-lg-12 col-xs-12 no-gutter page-header">
			...
			<div class="col-lg-4 col-xs-4">
				...
				<a href="" class="btn btn-info pull-right"><i class="fa fa-calendar"> Add Dates</i></a>
			</div>
		</div>
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<table class="table  table-bordered table-striped table-condensed">
							...
							<td><?= Html::a($order->order_date,['orders/view','id'=>$order->id],['role'=>'modal-remote'])?></td>
							
							<td><?= Html::a('<i class="fa fa-inr"></i> &nbsp;'.$order->total_amount,['orders/breakup','id'=>$order->id],['role'=>'modal-remote'])?></td>
							</tr>
							<?php } ?>
						</table>
					</div>
				...
				<div class="panel panel-success">
					...
					<div class="panel-body">
						<table class="table table-bordered table-striped table-condensed">
							...
							<td><?= Html::a(ucfirst($referral['name']),['customer-stats','id'=>$referral['id']],['role'=>'modal-remote'])?></td>
