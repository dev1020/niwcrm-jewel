...
?>
	...
	<div class="login-box">
		<div class="login-logo" >
			<?= Html::img((($settings_getter->get_attribute_value('site-logo') != NULL)? '@frontendimage/settings/'.$settings_getter->get_attribute_value('site-logo') : '@web/images/logo.png'), ['alt'=>Yii::$app->name])?>
		</div>
