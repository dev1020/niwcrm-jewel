...
<div class="row">
	...
	<div class="col-md-10 ">
		<h3><strong> Employees List </strong> <?= Html::a('Add Employee', ['create'], ['class' => 'btn btn-success right']) ?><?= Html::a('Add Customer by OTP', ['createbyotp'], ['class' => 'btn btn-primary right']) ?></h3>
			<?= GridView::widget([
