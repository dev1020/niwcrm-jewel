	...
	<div class="row">
		<div class="col-lg-12">
			...
			<?php if (!Yii::$app->request->isAjax){ 
				echo '<div class="form-group text-center">'.Html::a('Add Services', ['/station/add-services-to-customer','id'=>$customer->id,'cust_session'=>$cust_session], ['class' => 'btn btn-success',]).'</div>';
			 } ?>
		</div>
	</div>
