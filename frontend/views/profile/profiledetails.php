    ...
    <div class="row">
		<div class="col-lg-12 col-xs-12 no-gutter page-header">
			...
			<div class="col-lg-6 col-xs-6">
				<label class="text-success"><?= ucwords($model->name) ?></label>
			</div>
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<table class="table  table-bordered table-striped table-condensed">
							...
							<td><?= Html::a($order->order_date,['profile/orders-view','id'=>$order->id],['title'=>'Details of Order '.str_pad($order->id, 10, '0', STR_PAD_LEFT), 'data-toggle'=>'tooltip','role'=>'modal-remote'])?></td>
							
							<td><?= Html::a('<i class="fa fa-inr"></i> &nbsp;'.$order->total_amount.' &nbsp;'.($order->due_amount>0?'<span class="label label-danger">Due</span>':'<span class="label label-success">Paid</span>'),['profile/orders-price-breakup','id'=>$order->id],['title'=>'Payments of Order '.str_pad($order->id, 10, '0', STR_PAD_LEFT), 'data-toggle'=>'tooltip','role'=>'modal-remote'])?></td>
							</tr>
							<?php } ?>
						</table>
					</div>
