...
<div class="orders-view">
    ...
    <div class="row">
		...
		<div class="col-lg-12 col-xs-12 ">
			<table class="table">
				<tr>
					<td><i class="fa fa-user"></i>&nbsp;&nbsp;<strong><?= ucwords($model->cust->name)?></strong><br><i class="fa fa-phone"></i>&nbsp;<?= $model->cust->contact?><br><i class="fa fa-home"></i>&nbsp;<?= $model->cust->address?></td>
	...
	<div class="row">
		...
		<h3>Order Details</h3>
			<table class="table table-bordered table-striped table-condensed orderdetails">
				...
				<tbody>
					<?php foreach($model->ordersDetails as $details){?>
					<tr>
